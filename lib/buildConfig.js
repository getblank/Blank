...
function loadSettings(configPath) {
    ...
    settings.assetsPaths.push({ "folder": "blank", "file": "index.html", "data": fs.readFileSync(indexPath, "utf8") });
    settings.assetsPaths.push({ "folder": "blank", "file": "bootstrap.css", "data": fs.readFileSync(bootstrapCssPath, "utf8") });
