...
function babelifyProps(props) {
    for (let propName of Object.keys(props)) {
        ...
        if (propDesc.loadComponent) {
            if (typeof propDesc.loadComponent === "function") {
                propDesc.loadComponent = propDesc.loadComponent.toString();
            }
            propDesc.loadComponent = babel.transform(propDesc.loadComponent, {
                presets: ["latest", "react"], plugins: [["transform-strict-mode", {
                    "strict": true,
                }]],
            }).code;
            console.warn(propDesc.loadComponent);
        }
        if (propDesc.type === "virtual/client" && propDesc.load) {
            propDesc.load = babel.transform(stringifyFunction(propDesc.load, true), {
                presets: ["latest", "react"], plugins: [["transform-strict-mode", {
                    "strict": true,
                }]],
            }).code;
