...
function build() {
    ...
    let confPaths = [_path3.default.normalize(configPath + _path3.default.sep), _path3.default.normalize(defaultConfigPath + _path3.default.sep)];
    ...
    for (let i = 0; i < extraWatch.length; i++) {
        confPaths.push(_path3.default.resolve(configPath, extraWatch[i]) + _path3.default.sep);
    }

    console.log(`Building blank from: ${ configPath }`);
    prepareConfig();
    (0, _postZip2.default)(libPaths, "lib", output);
    (0, _postZip2.default)(assetsPaths, "assets", output);

    if (watch) {
        let configTimer = null,
            libTimer = null,
            assetsTimer = null;
        let configWatcher = _chokidar2.default.watch(confPaths, {
            persistent: true,
            ignoreInitial: true,
        ...
        libWatcher.on("change", function (_path) {
            ...
            libTimer = setTimeout(() => (0, _postZip2.default)(libPaths, "lib", output), 500);
        });
        ...
        assetsWatcher.on("change", function (_path) {
            ...
            assetsTimer = setTimeout(() => (0, _postZip2.default)(assetsPaths, "assets", output), 500);
        });
    }
